...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <header class="bg-[#274060] h-20 flex">
        <div class="w-5/6 mx-auto flex items-center justify-between">
            <div class="">
            <a href="<?php echo e(url('/')); ?>"><img class="h-16 " src="<?php echo e(asset('images/logo.webp')); ?>" alt="Logo"></a>
            </div>
            <div class="">
...
<?php /**PATH C:\Users\yaels\VakantieBlog\resources\views/welcome.blade.php ENDPATH**/ ?>